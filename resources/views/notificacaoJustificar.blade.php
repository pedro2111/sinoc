                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                <div class="panel-body nopaddingtop">
                                    <form id='basicForm' name='basicForm' enctype="multipart/form-data"
                                          action='{{ url("notificacao/incluirjustificativa/")}}' method="post"
                                          class='form-horizontal'>
                                        <input type="hidden" name="id_notificacao"
                                               value="{{ $Notificacao->id_notificacao }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="created_at" id="created_at"
                                                       value="{{ $Notificacao->created_at->format('d/m/Y H:i') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="ma_cadastro" id="ma_cadastro"
                                                       value="{{ $Notificacao->ma_cadastro }}" class="form-control"
                                                       title="Informe o nome do contexto" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="select2" id="id_notificadora" name="id_notificadora"
                                                        style="width: 100%"
                                                        data-placeholder="Selecione a coordenação notificadora"
                                                        title="Você precisa selecionar a coordenação notificadora"
                                                        disabled>
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="select2" id="id_impactada" name="id_impactada"
                                                        style="width: 100%"
                                                    ...
                                                    @foreach ($Contratos as $Contrato)
                                                        @if ($Notificacao->id_contrato === $Contrato->id_contrato)
                                                            <option value="{{ $Contrato->id_contrato }}"
                                                                    selected>{{ $Contrato->nu_contrato }}</option>
                                                        @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="select2" id="id_indicador" name="id_indicador"
                                                        style="width: 100%" disabled>
                                                    <option value=""></option>
                                                    ...
                                                    @foreach ($Indicadores as $indicador)
                                                        @if ($Notificacao->id_indicador === $indicador->id_indicador)
                                                            <option value="{{ $indicador->id_indicador }}"
                                                                    selected>{{ $indicador->no_indicador }}</option>
                                                        @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="ds_ocorrencia" id="ds_ocorrencia"
                                                       value="{{ $Notificacao->ds_ocorrencia }}" class="form-control"
                                                       title="Informe o nome do contexto" disabled/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="panel-body col-sm-9" style="margin-left:-10px">
                                                <textarea style="width:90.7%;" class="wtext" name="ds_ticket"
                                                          id="ds_ticket" placeholder="descrição do ticket..."
                                                          class="form-control" rows="10"
                                                          disabled>{{ $Notificacao->ds_ticket }}</textarea>
                                            </div>
                                        </div><!-- form-group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                @foreach ($Motivos as $motivo)
                                                    <input name="id_motivo[]" type="radio"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="panel-body col-sm-9" style="margin-left:-10px">
                                                <textarea style="width:90.7%;" id="ds_notificacao" name="ds_notificacao"
                                                          class="wtext" placeholder="descrição da notificação..."
                                                          class="form-control" rows="18"
                                                          disabled>{{ $Notificacao->ds_notificacao }}</textarea>
                                            </div>
                                        </div><!-- form-group -->


                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Duração da inconformidade (em
                                                horas):</label>
                                            <div class="col-sm-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4" style='padding-top:12px;'>
                                                @if($Notificacao->nome_anexo)
                                                    <a href='{{ url('../storage/uploads') }}/{{ $Notificacao->nome_anexo}}'
                                                       target='_new'>{{ $Notificacao->nome_anexo}}</a>
                                                @else
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"><b>Informe sua justificativa</b><span
                                                        class="text-danger">*</span> </label>
                                            <div class="panel-body col-sm-9" style="margin-left:-10px">
                                                    <textarea style="width:90.7%;" name="ds_justificativa" id="ds_justificativa" class="wtext" placeholder="descrição da justificativa..." class="form-control" rows="9" title="Campo Justificativa Obrigatório!! Favor preencher!" required></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Arquivo anexo: </label>
                                            <div class="col-sm-8">
                                                <input type="file" name="justificativa_anexo" id="justificativa_anexo"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                ...
                                                <button type="button" onClick="history.back();"
                                                        class="btn btn-wide btn-default btn-quirk">Cancelar
                                                </button>
                                            </div>
                                        </div>
