                      ...
                      <div class="form-group">
                       ...
                       <div class="panel-body col-sm-9" style="margin-left:-10px">
                          <textarea style="width:90.7%;" name="ds_justificativa" id="ds_justificativa" placeholder="descrição da justificativa..." class="wtext" rows="9" disabled>{{ $Notificacao->ds_justificativa }}</textarea>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Data da justificativa<span class="text-danger">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Responsável pela justificativa<span class="text-danger">*</span></label>
                                <div class="col-sm-8">
